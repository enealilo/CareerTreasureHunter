  ...
  return (
    <div className="flex flex-col m-auto mt-[100px] w-[600px] bg-[#fff] pb-[30px]">
      <div className="flex flex-col items-center gap-[10px] w-[100%] mt-[30px]">
        <h1 className="text-[#0A65CC] text-[50px] font-[700]">Sign Up</h1>
      ...
      <div className="mt-[55px] flex flex-col gap-[25px]">
        <div className="flex items-center m-auto w-[480px] h-[80px] bg-[#eaeaea] rounded-[5px]">
          <img src={user_icon} alt="" className="mx-0 my-[30px] p-2" />
          <input type="text" placeholder="NAME"  className="h-[50px] w-[400px] bg-transparent rounded-none outline-none text-[#797979] font-[20px] p-2"/>
        </div>
        <div className="flex items-center m-auto w-[480px] h-[80px] bg-[#eaeaea] rounded-[5px]">
      ...
      <div className="flex gap-[30px] mx-auto my-[40px]">
        <div className="flex justify-center items-center w-[220px] h-[60px] text-[#fff] bg-[#0A65CC] rounded-[50px] text-[20px] font-[700] cursor-pointer">Sign Up</div>
      </div>
    </div>
  );
}
